...
export const PetDetailModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-right">
          ...
          <p><strong>Species:</strong> Turtle / Red-Eared Slider</p>
          <p><strong>Size:</strong> Small</p>
          <p><strong>Color:</strong> Green</p>
          <p><strong>Age:</strong> Not Specified</p>
          <p><strong>Owner:</strong> OWNER SUR</p>
          <p><strong>Available Since:</strong> 04/27/2024</p>
